...
namespace Chatprogramm_github
{
    class Save
    {
        ...
        public static void SaveData(User Mainuser, Message receivedMessage)
        {
            ...
            {
                MessageBox.Show("Die empfangene Nachricht konnte nicht gespeichert werden. Bitte überprüfen Sie die Sicherungsdatei.");
        ...
        public static void CreateNewBackupfile(User Mainuser)
        {
            ...
            {
                MessageBox.Show("Es konnte keine Sicherungsdatei erstellt werden.");
            }
        ...
        public static void DeleteContact(User contact)
        {
            ...
            {
                MessageBox.Show("Der Kontakt konnte nicht gelöscht werden. Bitte überprüfen Sie die Sicherungsdatei und versuchen Sie es erneut.");
            }
